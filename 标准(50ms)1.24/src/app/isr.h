...
#define VECTOR_065    USART2_IRQHandler   //重新定义63号中断的ISR：UART1：Single interrupt vector for UART status sources
...
#undef  VECTOR_071
#define VECTOR_071    USART5_IRQHandler
